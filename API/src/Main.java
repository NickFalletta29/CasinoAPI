...
public class Main {
    public static void main(String[] args) {
        ...
        SpendingLimit model = new SpendingLimit(notif);
       ...
       // user authentication continued 
        User user = new User(userId, userId, userId, userId, 0, userId, userId);
        UserView authView = new UserView(user, notif);
        ...
        // Transaction Testing
        TransactionController transactionController = new TransactionController(model);
